...
<head>
    ...
    <style>
        ...
        /* Style the container that holds the feed consumption report content */
        .container {
            max-width: 1200px;
            margin: 0 auto;
            padding: 20px;
        ...
        /* Style the feed consumption table */
        table {
            width: 100%;
    ...
    <div class="container">
        ...
        <table>
            ...
            <tbody>
                ...
                // SQL query to retrieve feed consumption records
                $sql = "SELECT date, feed_type, quantity FROM feed_consumption";
